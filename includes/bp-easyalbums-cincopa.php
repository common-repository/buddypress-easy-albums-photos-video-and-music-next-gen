...
define("EASYALBUMS_CINCOPA_REGEXP", "/\[eacincopa ([[:print:]]+?)\]/");
...
cp_load_widget("'.urlencode($match[1]).'", "_cp_widget_'.$uni.'");
</script>
';

	$ret .= '<noscript>Click <a href="http://www.cincopa.com/media-platform/view.aspx?fid='.urlencode($match[1]).'">here</a> to open the gallery.<br>';
