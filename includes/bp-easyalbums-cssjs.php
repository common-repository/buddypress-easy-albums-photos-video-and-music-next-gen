...
function bp_easyalbums_add_css() {
	global $bp;
		...
		//wp_enqueue_script('bp-easyalbums-js', '//www.cincopa.com/media-platform/runtime/libasync.js');
		...
		wp_enqueue_style( 'bp-easyalbums-css-bpress', plugins_url($myPath.'/css/bpress.css') );
		wp_print_styles();
		
}
add_action( 'wp_head', 'bp_easyalbums_add_css' );

function bp_easyalbums_add_libasync() {
    wp_register_script('bp-easyalbums-libasync', '//www.cincopa.com/media-platform/runtime/libasync.js');
    wp_enqueue_script('bp-easyalbums-libasync');
}
add_action( 'wp_enqueue_scripts', 'bp_easyalbums_add_libasync' );
?>